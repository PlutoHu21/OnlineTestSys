...
class FileAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        for i in lists:
            if i['题型'] == '单选题':
                new_sc_question = SC_question(SC_text=i['问题描述'], SC_solution=i['正确答案'], value=i['分值'],
                                              paper=new_paper)
                ...
                new_mc_question = MC_question(MC_text=i['问题描述'], MC_solution=i['正确答案'], value=i['分值'],
                                              paper=new_paper)
                ...
                new_blank_question = Blank_question(blank_text=i['问题描述'], blank_solution=i['正确答案'],
                                                    value=i['分值'], paper=new_paper)
